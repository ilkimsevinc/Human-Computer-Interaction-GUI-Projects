...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to Sakura Store!</h1>
                    <p>Get 3% Daily Cash back with Apple Card. And pay for your new iPhone over 24 months, interest-free when you choose Apple Card Monthly Installments.* </p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/iPhone-12-699dalırs.png" alt="iPhone 12">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>iPhone 12</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/iPhone-11-599dalırs.png" alt="iPhone 11">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>iPhone 11</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/iPhone-SE-399dalırs.png" alt="iPhone SE">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>iPhone SE</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/aaMacBook-Pro-16inc-2399dalırs.png" alt="MacBook Pro 16 inch">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/bbiMac-24inc-1299dalırs.png" alt="iMac Pro 24 inch">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>iMac Pro 24 inch</h3>
                                    <p>Price: 1299$</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/iMac-27inç-1799dalırs.png" alt="iMac Pro 27 inch">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>iMac Pro 27 inch</h3>
                                    <p>Price: 1799$</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Mac-Mini-699dalırs.png" alt="Mac Mini">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Mac Mini</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Mac-Pro-5999dalırs.png" alt="Mac Pro">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Mac Pro</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Airpods-Max-599dalırs.png" alt="Airpods Max">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Airpods Max</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Airpods-Pro-299dalırs.png" alt="Airpods Pro">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Airpods Pro</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/ccAirpods-With-Wireless-Charge-Case-200dalırs.png" alt="Airpods With Wireless Charge">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Airpods With Wireless Charge</h3>
                                    <p>Price: 200$</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
